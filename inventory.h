...
// Locates a product by itemIndex, confirms with the user, then unlinks and
// deletes the node. Adjusts head pointer if needed.
...
// Scans the list and prints any products whose stock is at or below the
// LOW_STOCK_THRESHOLD defined in inventory.cpp.
